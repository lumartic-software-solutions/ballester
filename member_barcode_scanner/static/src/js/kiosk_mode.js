...
var MemberKioskMode = Widget.extend({
	 events: {
	        "click .o_hr_attendance_button_members": function(){ this.do_action('member_barcode_scanner.member_attendance_action_kanban'); },
	        //"click .continue_button": function(){Session.employee_id = this.employee_id; Session.employee = this.employee; Session.employee_image_url = this.employee_image_url ;this.do_action('ballester_screen.action_ballester_screen'); 
		//	},
...
//                  return self.do_action(action);
                   console.log("dddddddddddd-----------------------",Session)
            	  ...
            	  self.$el.html(QWeb.render("MemberAttendanceWelcome", {widget: self}));
		if (self.attendance_state == 'checked_in'){
		setTimeout(function () {
				self.do_action('ballester_screen.action_ballester_screen');
			    }, 2000);
			}
//              }
