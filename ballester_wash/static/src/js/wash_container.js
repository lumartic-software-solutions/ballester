...
odoo.define('ballester_wash.wash_container', function (require) {
"use strict";
...
var WashContainerMode = Widget.extend({
	
	 events: {
	      //  "click .o_wash_container_button": function(){ this.do_action('member_barcode_scanner.member_attendance_action_kanban'); },
	      //  "click .continue_container_button": function(){Session.employee_id = this.employee_id; Session.employee = this.employee; Session.employee_image_url = this.employee_image_url ;this.do_action('ballester_wash.action_ballester_container_display_screen'); },
	        'keypress #wash_container' : 'on_manual_scan',
     ...
     //   core.bus.on('barcode_scanned', this, this._onBarcodeScanned);
        ...
        var def = this._rpc({
            ...
            .then(function (companies){
                ...
                self.$el.html(QWeb.render("ContainerWash", {widget: self}));
                self.start_clock();
            });
...
_onBarcodeScanned: function(barcode) {
        ...
        console.log("IIIIIIIIIIIIIIIIIII",barcode)
        this._rpc({
                model: 'hr.employee',
...
//                  return self.do_action(action);
            	  ...
            	  self.$el.html(QWeb.render("ContainerWashWelcome", {widget: self}));
		if (self.attendance_state == 'checked_in'){
		 setTimeout(function () {
				self.do_action('ballester_wash.action_ballester_container_display_screen');
			    }, 2000);
		}
		else {
		setTimeout(function () {
...
core.action_registry.add('ballester_washed_container_screen_act', WashContainerMode);


return {
    WashContainerMode: WashContainerMode,
    Success: Success,
