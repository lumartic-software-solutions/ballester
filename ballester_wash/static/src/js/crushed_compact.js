...
odoo.define('ballester_wash.crushed_compact', function (require) {
"use strict";
...
var WashcrushcompactMode = Widget.extend({
	 events: {
	        //"click .o_wash_container_button": function(){ this.do_action('member_barcode_scanner.member_attendance_action_kanban'); },
	        //"click .continue_crush_compact_button": function(){Session.employee_id = this.employee_id; Session.employee = this.employee; Session.employee_image_url = this.employee_image_url ;this.do_action('ballester_wash.action_ballester_crush_compact_display_screen'); },
	        'keypress #crush_and_compact' : 'on_manual_scan',
	    },
...
//        core.bus.on('barcode_scanned', this, this._onBarcodeScanned);
        ...
        var def = this._rpc({
            ...
            .then(function (companies){
                ...
                self.$el.html(QWeb.render("CrushandCompact", {widget: self}));
...
//                  return self.do_action(action);
            	  ...
            	  self.$el.html(QWeb.render("CrushandCompactWelcome", {widget: self}));
		...
		setTimeout(function () {
				self.do_action('ballester_wash.action_ballester_crush_compact_screen');
			    }, 2000);
...
core.action_registry.add('ballester_crush_compact_screen_act', WashcrushcompactMode);


return {
    WashcrushcompactMode: WashcrushcompactMode,
    Success: Success,
