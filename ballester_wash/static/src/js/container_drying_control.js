...
odoo.define('ballester_wash.container_drying_control', function (require) {
"use strict";
...
var WashDryingContainerMode = Widget.extend({
	 events: {
	      //  "click .o_wash_container_button": function(){ this.do_action('member_barcode_scanner.member_attendance_action_kanban'); },
	      //  "click .continue_container_dry_button": function(){Session.employee_id = this.employee_id; Session.employee = this.employee; Session.employee_image_url = this.employee_image_url ;this.do_action('ballester_wash.action_ballester_container_drying_display_screen'); },
	        'keypress #wash_dry_container' : 'on_manual_scan',
	    },
...
//        core.bus.on('barcode_scanned', this, this._onBarcodeScanned);
        ...
        var def = this._rpc({
            ...
            .then(function (companies){
                ...
                self.$el.html(QWeb.render("ContainerdrycontrolWash", {widget: self}));
...
//                  return self.do_action(action);
            	  ...
            	  self.$el.html(QWeb.render("ContainerdrycontrolWashWelcome", {widget: self}));
			if (self.attendance_state == 'checked_in'){
		setTimeout(function () {
				self.do_action('ballester_wash.action_ballester_container_drying_display_screen');
			    }, 2000);
		}
			else {
		setTimeout(function () {
...
core.action_registry.add('ballester_washed_drying_screen_act', WashDryingContainerMode);


return {
    WashDryingContainerMode: WashDryingContainerMode,
    Success: Success,
